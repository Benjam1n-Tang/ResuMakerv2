...
const IconButton = ({ text, onClick }: IconButtonProps) => {
  return (
    <button
      onClick={onClick}
      className="w-25 h-8 cursor-pointer hover:bg-dark-tLight dark:hover:bg-light-tLight flex justify-start gap-3.5 px-2 items-center"
    >
      {text === "Profile" && (
        <svg
