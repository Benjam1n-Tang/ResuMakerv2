...
const ThemeSwitch = () => {
  ...
  return (
    <div className="bg-light-fg w-24 h-6 rounded-sm flex text-light-t">

        <div className={`flex items-center justify-center flex-1 rounded-sm ${theme==="light" ? "bg-gray-300" : ""} cursor-pointer`} onClick={() => toggleTheme()}>
            <svg
       ...
       <div className={`flex items-center justify-center flex-1 rounded-sm ${theme==="dark" ? "bg-gray-300" : ""} cursor-pointer`} onClick={() => toggleTheme()}>
            <svg
          xmlns="http://www.w3.org/2000/svg"
          width="1.75em"
          height="1.75em"
